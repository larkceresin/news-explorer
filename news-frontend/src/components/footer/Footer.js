    ...
    return (
        <footer className="footer">
            ...
            <ul className="footer__content footer__content_icons">
                <li><a  href="https://github.com/larkceresin" target="_blank" rel="noreferrer"><img src={github} alt="github" class=" footer__icon"/></a></li>
                <li><a href="https://www.facebook.com/shamanlvr/" target="_blank" rel="noreferrer"><img src={facebook} alt="facebook" class="footer__icon "/></a></li>
            </ul>
            </div>
        </footer>
    )
